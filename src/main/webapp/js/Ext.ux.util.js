 ...
 *
 */
Ext.getStoreRow = function (store, value) {
...
Ext.getDate = Ext.apply({
    ...
    defaultDate: function (typeStartDate, addMonth = 1) {
        var day = new Date();
        var dd = day.getDate();
        var mm = day.getMonth() + addMonth;
        var yy = day.getFullYear() + 543;
...
Ext.floatRenderer = function (value) {
    if (value) {
        var nStr = value;
